    ...
    <>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="banner-blocks">
                ...
                <div class="banner-ad d-flex align-items-center large bg-info block-1 section2" >
                ...
                <div class="banner-ad bg-success-subtle block-2 secton3">
                ...
                <div class="banner-ad bg-danger block-3 section4">
                  <div class="banner-content align-items-center p-5">
                    <div class="content-wrapper text-light">
      ...
      <section>
        <div class="container-lg">
          ...
          <div class="bg-secondary text-light py-5 my-5 section5">
            <div class="container">
